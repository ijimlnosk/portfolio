...
const mockUserInfo = {
    ...
    developerValues: [
        {
            title: "지속적인 학습",
            description: `다양한 언어와 기술을 학습하는 것은 문제 해결 능력을 키우는 데 도움을 주며
나아가 개발 역량을 확장하는 데 필수적인 요소라고 생각합니다.
새로운 개념을 익히고 적용하는 과정에서 깊이 있는 이해를 쌓아가는 것에 흥미를 느끼고 있습니다.
현재는 React Native 공부를 하고 있습니다.`,
        },
        {
            title: "협업",
            description: `원활한 협업을 위해서는 체계적인 소통이 필수적이라고 생각합니다.
PR을 통해 개인의 작업 내용과 상황을 정리, 공유하는 것은 병목 현상을 빠르게 해결할 수 있게 
도와줄 뿐만 아니라 프로젝트 진행 상황을 투명하게 유지하는 데 도움이 됩니다.
개발자 커뮤니티에서 다양한 프로젝트를 진행하며 협업의 중요성을 실감했고,
효율적인 협업을 위해 명확한 커뮤니케이션과 책임감 있는 개발을 지향하고 있습니다.`,
        },
    ],
    moreInfo: [
        {

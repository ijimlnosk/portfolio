...
const UserInfo = () => {
    ...
    return (
        <div className="w-[680px] h-full relative pb-4 pl-4 pr-3 flex flex-row overflow-y-auto">
            <div className="w-full">
                <div className="w-[670px] h-[50px] pt-4 flex flex-row mb-12 sticky top-0 bg-white">

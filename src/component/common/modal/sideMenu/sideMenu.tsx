...
const SideMenu = ({
    ...
    return (
        <div
            className={`${skillTitle === "Project" ? "w-[17%]" : "w-[25%]"} ${type === "folder" ? "bg-white bg-opacity-80" : "bg-[#e2e2e2]"}  bg-opacity-60 backdrop-blur-md p-2 rounded-l-lg`}
        >
